...
// import { BaseFontSize, Cozlor } from "../../utils/color";
// import Breadcrumbs from "nextjs-breadcrumbs";
// import l from "../../assets/afriinvestzzzz.png";
...
function PerArticle() {
  ...
  console.log("🚀 ~ PerArticle ~ router:", router)
...
export async function getStaticPaths() {
  const articles = await axios.get("/api/articles?fields[0]=title");
